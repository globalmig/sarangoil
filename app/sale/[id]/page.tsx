...
export default async function PropertyDetail({ params }: { params: { id: string } }) {
  ...
  return (
    <section className="my-10 w-full max-w-[1440px] px-4 mt-20 md:mt-40">
      <div className="max-w-[960px] mx-auto bg-white border rounded-lg shadow-sm p-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex gap-2">
            <Link href="/sale?category=gas-station" className="text-sm text-zinc-600 hover:underline text-end w-full">
              목록으로
            </Link>
